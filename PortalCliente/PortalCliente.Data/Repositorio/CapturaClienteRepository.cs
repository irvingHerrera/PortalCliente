...
{
    public class CapturaClienteRepository : DataBaseAcces, ICapturaClienteRepository
    {
        ...
        public DataTable ObtenerContactosCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerContactosCliente");
            return resultado;
        }
        ...
        public DataTable ObtenerCtasBancPECACliente(string id_precliente)
        {
            ...
            parametro.Add(new SqlParameter
            {
                Value = Convert.ToInt32(id_precliente),
                SqlDbType = SqlDbType.Int,
                ParameterName = "@id_precliente"
            });

            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerCuentasBancariasPECACliente");
            return resultado;
        }
        ...
        public DataTable ObtenerUsrAduabookCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerUsuariosAduabookCliente");
            return resultado;
        }
        ...
        public DataTable ObtenerCuestionarioCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerCuestionarioCliente");
            return resultado;
        }

        public DataTable ObtenerNumeroTabuladores(int idUsuario, int idPrecliente)
        {
            var parametro = new List<SqlParameter>();
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerTotalTabuladores");
            return resultado;
        }
        ...
        public DataTable ObtenerDocumentosCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerDocumentosCliente");
            return resultado;
        }

        public DataTable ObtenerDocumentosClienteExpediente(string id_precliente)
        {
            var parametro = new List<SqlParameter>();
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ObtenerDocumentosClienteExpediente");
            return resultado;
        }
        ...
        public DataTable GuardarRevisionDocumentosCliente(string id_precliente, string id_usuario)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_GuardarRevisionDocumentosCliente");
            return resultado;
        }

        public int? GuardarTabuladores(TabuladorDTO tabuladores)
        {
            var parametro = new List<SqlParameter>();
            ...
            var resultado = ExecuteNoQuery(parametro, "dbo.csp_tblCLI_GuardarDatosTabuladores");
        ...
        public int? GuardarTabuladorEmpresa(List<EmpresaTabuladorDTO> empresa, int? id_tabulador_tab)
        {
            ...
            var resultado = ExecuteNoQuery(parametro, "dbo.csp_tblCLI_GuardarTabuladorEmpresa");
            return resultado;
        }
        ...
        public int? GuardarTab(TabuladorDinamicoDTO dinamico, int numeroTab, int IDPrecliente)
        {
            ...
            var salida = Select(parametro, "dbo.csp_tblCLI_GuardarTab");
            int resultado = 0;
        ...
        private void TablaTabuladorDinamico(List<TabuladorDinamicoDTO> dinamico, int IDPrecliente)
        {
            ...
            foreach (var item in dinamico)
            {
                ...
                GuardarTabuladorEmpresa(item.Empresa, id_tabulador_tab);
            }
        }
        ...
        public DataTable ValidaNumeroDocumentosRevisados(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ValidaNumeroDocumentosRevisados");
            return resultado;
        }
        ...
        public DataTable BuscarDatosTabuladores(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_BuscarDatosTabuladores");
            return resultado;
        }
        ...
        public DataTable BuscarDatosTabuladoresContactos(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_BuscarDatosTabuladoresContactos");
            return resultado;
        }
        ...
        public DataTable BuscarDatosTabuladoresTarifas(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_BuscarDatosTabuladoresTarifas");
            return resultado;
        }
        ...
        public DataTable BuscarDatosTabuladoresTabs(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_BuscarDatosTabuladoresTabs");
            return resultado;
        }
        ...
        public DataTable BuscarDatosTabuladoresEmpresa(string id_tabulador_tab)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_BuscarDatosTabuladoresEmpresa");
            return resultado;
        }
        ...
        public DataTable GuardarTerminarProcedimientoOperacion(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_GuardarTerminarProcedimientoOperacion");
            return resultado;
        }
        ...
        public DataTable ActivarCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_ActivarCliente");
            return resultado;
        }
        ...
        public DataTable InactivarCliente(string id_precliente)
        {
            ...
            var resultado = Select(parametro, "dbo.csp_CLI_InactivarCliente");
            return resultado;
        }
    }
}
