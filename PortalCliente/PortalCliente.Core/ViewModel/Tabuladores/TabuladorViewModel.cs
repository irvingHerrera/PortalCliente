...
{
    public class TabuladorViewModel
    {
        public TabuladorViewModel()
        {
            TabuladorDinamico = new List<TabuladorDinamicoViewModel>();
        }

        public int IdPrecliente { get; set; }
        public int IdUsuario { get; set; }
        public string EjecutivoVenta { get; set; }
        public EquipoOperativoViewModel EquipoOperativo { get; set; }
